...
pylab.title(regressor_name + "'s Mean Absolute Error and MSE of predictions after time delta")
pylab.xlabel("time delta += 1 hour")
pylab.ylabel("Error")
ax = pylab.gca()
ax.set_xticks(np.arange(0,hours_limit+1,5))
ax.set_yticks(np.arange(0,101,10))
plt.grid()
pylab.savefig('../img/'+regressor_name+'_hour_error.png')
pylab.show()
